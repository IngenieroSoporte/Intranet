...
class PermissionsTableSeeder extends Seeder
{
    public function run()
    {
        $permissions = [
            ...
            [
                'id'    => 252,
                'title' => 'ofimatica_create',
            ],
            [
                'id'    => 253,
                'title' => 'ofimatica_edit',
            ],
            [
                'id'    => 254,
                'title' => 'ofimatica_show',
            ],
            [
                'id'    => 255,
                'title' => 'ofimatica_delete',
            ],
            [
                'id'    => 256,
                'title' => 'ofimatica_access',
            ],
            [
                'id'    => 257,
                'title' => 'formacion_academica_profesional_create',
            ],
            [
                'id'    => 258,
                'title' => 'formacion_academica_profesional_edit',
            ],
            [
                'id'    => 259,
                'title' => 'formacion_academica_profesional_show',
            ],
            [
                'id'    => 260,
                'title' => 'formacion_academica_profesional_delete',
            ],
            [
                'id'    => 261,
                'title' => 'formacion_academica_profesional_access',
            ],
            [
                'id'    => 262,
