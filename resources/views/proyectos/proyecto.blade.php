...
<head>
    ...
    <title>Proyectos Articulados</title>
...
<body style="background: url(&quot;assets/img/fondoiconos.png&quot;);background-size: cover;">
    ...
    <!-- Boton Buscar-->
    <nav class="navbar navbar-light float-right mr-5">
...
<div class="container">
    <div class="row">
    @foreach ($articulado as $id=>$activo)
        ...
        <div class="col-4">
            ...
            <div class="container my-5 text-center">
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                      <h5 class="card-title">{{$activo->titulo_del_trabajo}}</h5>
                      <p class="card-text">{{$activo->linea_de_investigacion}}</p>
                      <p class="card-text">{!!substr($activo->abstract_resumen_documental, 0,150)!!}</p>
                      <a href="{{ $activo->proyecto->getUrl() }}" target="_blank" class="btn btn-danger">Descargar</a>
                    </div>
                  </div>
               </div>
...
<div class="container">{{$articulado->links()}}</div>
