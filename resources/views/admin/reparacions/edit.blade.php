    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.reparacions.update", [$reparacion->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('descripcion') ? 'is-invalid' : '' }}" name="descripcion" id="descripcion" required>{{ old('descripcion', $reparacion->descripcion) }}</textarea>
