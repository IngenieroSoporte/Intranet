...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.importarEmpleado.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.importar-empleados.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cedula') ? 'is-invalid' : '' }}" type="number" name="cedula" id="cedula" value="{{ old('cedula', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lugar_de_expedicion_de_la_cedula') ? 'is-invalid' : '' }}" type="text" name="lugar_de_expedicion_de_la_cedula" id="lugar_de_expedicion_de_la_cedula" value="{{ old('lugar_de_expedicion_de_la_cedula', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cargo_actual') ? 'is-invalid' : '' }}" type="text" name="cargo_actual" id="cargo_actual" value="{{ old('cargo_actual', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('fecha_de_inicio_contrato_actual') ? 'is-invalid' : '' }}" type="text" name="fecha_de_inicio_contrato_actual" id="fecha_de_inicio_contrato_actual" value="{{ old('fecha_de_inicio_contrato_actual') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('salario_en_letras') ? 'is-invalid' : '' }}" type="text" name="salario_en_letras" id="salario_en_letras" value="{{ old('salario_en_letras', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('fecha_inicial_del_primero_contrato') ? 'is-invalid' : '' }}" type="text" name="fecha_inicial_del_primero_contrato" id="fecha_inicial_del_primero_contrato" value="{{ old('fecha_inicial_del_primero_contrato') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('fecha_final_del_primero_contrato') ? 'is-invalid' : '' }}" type="text" name="fecha_final_del_primero_contrato" id="fecha_final_del_primero_contrato" value="{{ old('fecha_final_del_primero_contrato') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('fecha_inicial_del_segundo_contrato') ? 'is-invalid' : '' }}" type="text" name="fecha_inicial_del_segundo_contrato" id="fecha_inicial_del_segundo_contrato" value="{{ old('fecha_inicial_del_segundo_contrato') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('fecha_final_del_segundo_contrato') ? 'is-invalid' : '' }}" type="text" name="fecha_final_del_segundo_contrato" id="fecha_final_del_segundo_contrato" value="{{ old('fecha_final_del_segundo_contrato') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fecha_inicial_del_tercer_contrato') ? 'is-invalid' : '' }}" type="text" name="fecha_inicial_del_tercer_contrato" id="fecha_inicial_del_tercer_contrato" value="{{ old('fecha_inicial_del_tercer_contrato', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('fecha_final_del_tercer_contrato') ? 'is-invalid' : '' }}" type="text" name="fecha_final_del_tercer_contrato" id="fecha_final_del_tercer_contrato" value="{{ old('fecha_final_del_tercer_contrato') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('fecha_inicial_del_cuarto_contrato') ? 'is-invalid' : '' }}" type="text" name="fecha_inicial_del_cuarto_contrato" id="fecha_inicial_del_cuarto_contrato" value="{{ old('fecha_inicial_del_cuarto_contrato') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('fecha_final_del_cuarto_contrato') ? 'is-invalid' : '' }}" type="text" name="fecha_final_del_cuarto_contrato" id="fecha_final_del_cuarto_contrato" value="{{ old('fecha_final_del_cuarto_contrato') }}">
