    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-componentesFichasTecnicas">
                    <thead>
                        <tr>
                            <th width="10">
...
@endcan
  ...
  let table = $('.datatable-componentesFichasTecnicas:not(.ajaxTable)').DataTable({ buttons: dtButtons })
