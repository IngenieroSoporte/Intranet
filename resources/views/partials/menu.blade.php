        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview {{ request()->is("admin/hojas-de-vidas*") ? "menu-open" : "" }} {{ request()->is("admin/empleos*") ? "menu-open" : "" }} {{ request()->is("admin/sg-ssts*") ? "menu-open" : "" }} {{ request()->is("admin/plan-de-formacions*") ? "menu-open" : "" }} {{ request()->is("admin/evaluacion-de-desempenos*") ? "menu-open" : "" }} {{ request()->is("admin/certificado-laborals*") ? "menu-open" : "" }} {{ request()->is("admin/cerficadodefunciones*") ? "menu-open" : "" }} {{ request()->is("admin/*") ? "menu-open" : "" }}">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @can('postulacione_access')
                                <li class="nav-item has-treeview {{ request()->is("admin/pruebas-psicotecnicas*") ? "menu-open" : "" }} {{ request()->is("admin/candidatos*") ? "menu-open" : "" }} {{ request()->is("admin/formacion-academica-profesionals*") ? "menu-open" : "" }} {{ request()->is("admin/idiomasgestionhumanas*") ? "menu-open" : "" }} {{ request()->is("admin/ofimaticas*") ? "menu-open" : "" }} {{ request()->is("admin/documentos-candidatos*") ? "menu-open" : "" }}">
                                    <a class="nav-link nav-dropdown-toggle" href="#">
                                    ...
                                    <ul class="nav nav-treeview">
                                        ...
                                        @endcan
                                        @can('formacion_academica_profesional_access')
                                            <li class="nav-item">
                                                <a href="{{ route("admin.formacion-academica-profesionals.index") }}" class="nav-link {{ request()->is("admin/formacion-academica-profesionals") || request()->is("admin/formacion-academica-profesionals/*") ? "active" : "" }}">
                                                    <i class="fa-fw nav-icon fas fa-cogs">

                                                    </i>
                                                    <p>
                                                        {{ trans('cruds.formacionAcademicaProfesional.title') }}
                                                    </p>
                                                </a>
                                            </li>
                                        @endcan
                                        ...
                                        @endcan
                                        @can('ofimatica_access')
                                            <li class="nav-item">
                                                <a href="{{ route("admin.ofimaticas.index") }}" class="nav-link {{ request()->is("admin/ofimaticas") || request()->is("admin/ofimaticas/*") ? "active" : "" }}">
                                                    <i class="fa-fw nav-icon fas fa-file-word">

                                                    </i>
                                                    <p>
                                                        {{ trans('cruds.ofimatica.title') }}
                                                    </p>
                                                </a>
                                            </li>
                                        @endcan
                ...
                @can('parametro_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/agentes*") ? "menu-open" : "" }} {{ request()->is("admin/sedes*") ? "menu-open" : "" }} {{ request()->is("admin/prioridads*") ? "menu-open" : "" }} {{ request()->is("admin/incidentes*") ? "menu-open" : "" }} {{ request()->is("admin/estados*") ? "menu-open" : "" }} {{ request()->is("admin/estudios*") ? "menu-open" : "" }} {{ request()->is("admin/salarios*") ? "menu-open" : "" }}">
                        <a class="nav-link nav-dropdown-toggle" href="#">
                            <i class="fa-fw nav-icon fas fa-cogs">
                            ...
                            @can('salario_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.salarios.index") }}" class="nav-link {{ request()->is("admin/salarios") || request()->is("admin/salarios/*") ? "active" : "" }}">
                                        <i class="fa-fw nav-icon fab fa-cc-diners-club">

                                        </i>
                                        <p>
                                            {{ trans('cruds.salario.title') }}
                                        </p>
                                    </a>
                                </li>
                            @endcan
