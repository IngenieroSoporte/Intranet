...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    Route::post('estudios/parse-csv-import', 'EstudiosController@parseCsvImport')->name('estudios.parseCsvImport');
    Route::post('estudios/process-csv-import', 'EstudiosController@processCsvImport')->name('estudios.processCsvImport');
    ...
    // Ofimatica
    Route::delete('ofimaticas/destroy', 'OfimaticaController@massDestroy')->name('ofimaticas.massDestroy');
    Route::resource('ofimaticas', 'OfimaticaController');
