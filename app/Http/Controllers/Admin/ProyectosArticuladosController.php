...
class ProyectosArticuladosController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $table->editColumn('titulo_del_trabajo', function ($row) {
                return $row->titulo_del_trabajo ? $row->titulo_del_trabajo : '';
            });
            $table->editColumn('nombres_y_apellidos_de_los_autores_de_la_investigacion', function ($row) {
                return $row->nombres_y_apellidos_de_los_autores_de_la_investigacion ? $row->nombres_y_apellidos_de_los_autores_de_la_investigacion : '';
            });
            $table->editColumn('nombres_y_apellidos_del_asesor_del_trabajo', function ($row) {
                return $row->nombres_y_apellidos_del_asesor_del_trabajo ? $row->nombres_y_apellidos_del_asesor_del_trabajo : '';
            });

            $table->editColumn('linea_de_investigacion', function ($row) {
                return $row->linea_de_investigacion ? $row->linea_de_investigacion : '';
            });
