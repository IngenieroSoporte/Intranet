...
class FichasTecnicasApiController extends Controller
{
    public function index()
    {
        ...
        return new FichasTecnicaResource(FichasTecnica::with(['componentes', 'sede', 'created_by'])->get());
    }
    ...
    public function show(FichasTecnica $fichasTecnica)
    {
        ...
        return new FichasTecnicaResource($fichasTecnica->load(['componentes', 'sede', 'created_by']));
    }
